...
class StagedChangesArray(Generic[T]):
    ...
    def __init__(
        ...
        shape: tuple[int, ...],
        chunk_size: tuple[int, ...],
        base_slabs: Sequence[NDArray[T]],  # actually any array-like
    ...
    def __setitem__(self, idx: Any, value: ArrayLike) -> None:
        ...
        value = cast(NDArray[T], asarray(value))
...
class ResizePlan(MutatingPlan):
    ...
    def __init__(
        ...
        if shrunk_shape != old_shape:
            ...
            self.drop_slabs = np.setdiff1d(slab_indices, self.slab_indices).tolist()
