...
def test_read_many_slices_param_nd(args):
    ...
    getitem_dst_view = getitem_dst[*(m.value_view_idx for m in mappers)]
    ...
    getitem_dst_view2 = getitem_dst2[*(m.value_view_idx for m in mappers)]
    read_many_slices(
    ...
    getitem_dst_view3 = getitem_dst3[*(m.value_view_idx for m in mappers)]
    read_many_slices(
        src=slab2slab_dst,
